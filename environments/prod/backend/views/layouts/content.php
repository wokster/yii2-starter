...
<?php
$this->registerJs("
if ((typeof(Storage) !== 'undefined') && localStorage.theme_class) {
    $('body').removeClass().addClass(localStorage.theme_class);
}
", \yii\web\View::POS_LOAD);
$this->registerJs("
$('#change_color li > a').on('click',function(){
var theme_class = $(this).data('skin') + ' sidebar-mini';
$('body').removeClass().addClass(theme_class);
if (typeof(Storage) !== 'undefined') {
    localStorage.setItem('theme_class', theme_class);
} else {
    alert('Ваш древний браузер не сможет запомнить Ваш выбор и при обновлении все вернется к изначальным насройкам.')
}
});
");
